...
const NAV: Array<{ id: ProductView; label: string; icon: IconName }> = [
  { id: "overview", label: "Overview", icon: "overview" }, { id: "risks", label: "Risks", icon: "risk" }, { id: "ask", label: "Ask X-Ray", icon: "ask" }, { id: "identities", label: "Identity review", icon: "identity" }, { id: "graph", label: "Explore graph", icon: "graph" },
